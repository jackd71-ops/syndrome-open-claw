...
function renderSticSku(data) {
  ...
  <div style="display:flex;align-items:flex-start;gap:16px;margin-bottom:14px">
    ...
    <div style="flex:1;display:flex;align-items:center;gap:6px;padding-right:40px">
      ...
      <textarea id="sku-notes-${info.product_id}" rows="1"
        ...
        style="flex:1;min-width:0;padding:3px 6px;font-size:12px;border:1px solid #C8C6C4;border-radius:2px;font-family:inherit;resize:none"
